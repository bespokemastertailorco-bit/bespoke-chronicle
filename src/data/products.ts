...
const suits: Product[] = [
  {
    ...
    images: ["https://images.unsplash.com/photo-1594938298603-c8148c4b4f8d?w=800&q=80"],
    sizes: SUIT_SIZES,
    category: "suits",
  ...
  },
  {
    ...
    images: ["https://images.unsplash.com/photo-1548369937-47519962c11a?w=800&q=80"],
    sizes: SUIT_SIZES,
    category: "suits",
  ...
  },
  {
    ...
    images: ["https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?w=800&q=80"],
    sizes: SUIT_SIZES,
    category: "suits",
  ...
  },
  {
    ...
    images: ["https://images.unsplash.com/photo-1614632537190-23e4e0326b28?w=800&q=80"],
    sizes: SUIT_SIZES,
    category: "suits",
  ...
  },
  {
    ...
    images: ["https://images.unsplash.com/photo-1600091166971-7f9faad6c08c?w=800&q=80"],
    sizes: SUIT_SIZES,
    category: "suits",
...
const blazers: Product[] = [
  ...
  },
  {
    ...
    images: ["https://images.unsplash.com/photo-1555069519-127aadecd574?w=800&q=80"],
    sizes: SUIT_SIZES,
    category: "blazers",
  ...
  },
  {
    ...
    images: ["https://images.unsplash.com/photo-1603189042723-b1e03a40bba9?w=800&q=80"],
    sizes: SUIT_SIZES,
    category: "blazers",
  ...
  },
  {
    ...
    images: ["https://images.unsplash.com/photo-1562137369-1a1a0bc66744?w=800&q=80"],
    sizes: SUIT_SIZES,
    category: "blazers",
  ...
  },
  {
    ...
    images: ["https://images.unsplash.com/photo-1588347785102-2944d3373b3b?w=800&q=80"],
    sizes: SUIT_SIZES,
    category: "blazers",
...
const coats: Product[] = [
  ...
  },
  {
    ...
    images: ["https://images.unsplash.com/photo-1490114538077-0a7f8cb49891?w=800&q=80"],
    sizes: SUIT_SIZES,
    category: "coats",
  ...
  },
  {
    ...
    images: ["https://images.unsplash.com/photo-1548126032-079a0fb0099d?w=800&q=80"],
    sizes: SUIT_SIZES,
    category: "coats",
...
const trousers: Product[] = [
  ...
  },
  {
    ...
    images: ["https://images.unsplash.com/photo-1550246140-5119ae4790b8?w=800&q=80"],
    sizes: TROUSER_SIZES,
    category: "trousers",
...
const shirts: Product[] = [
  ...
  },
  {
    ...
    images: ["https://images.unsplash.com/photo-1603251579431-8041402bdeda?w=800&q=80"],
    sizes: SHIRT_SIZES,
    category: "shirts",
